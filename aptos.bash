...
cd wormhole/aptos/scripts 

echo "Waiting for aptos to start..."
bash wait_for_devnet

echo "Deploying scripts and requesting tokens from faucet"

bash deploy devnet
worm aptos faucet
bash register_devnet
cd - 
